...
, 			{
		...
		"parameters" : 		{
			"obj-39::obj-33" : [ "led[7]", "led", 0 ],
			"obj-62::obj-33" : [ "led[10]", "led", 0 ],
			"obj-58::obj-33" : [ "led[1]", "led", 0 ],
			"obj-76" : [ "pw[4]", "pw", 0 ],
			"obj-61::obj-33" : [ "led[9]", "led", 0 ],
			"obj-42::obj-33" : [ "led[3]", "led", 0 ],
			"obj-27::obj-33" : [ "led[4]", "led", 0 ],
			"obj-33::obj-33" : [ "led[5]", "led", 0 ],
			"obj-52" : [ "freq[4]", "freq", 0 ],
			"obj-20" : [ "live.button", "live.button", 0 ],
			"obj-11" : [ "freq[5]", "freq", 0 ],
			"obj-48::obj-33" : [ "led[2]", "led", 0 ],
			"obj-75" : [ "pw[3]", "pw", 0 ],
			"obj-69" : [ "pw[5]", "pw", 0 ],
			"obj-38::obj-33" : [ "led[6]", "led", 0 ],
			"obj-40::obj-33" : [ "led[8]", "led", 0 ],
			"parameterbanks" : 			{
