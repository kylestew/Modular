...
,
		"classnamespace" : "box",
		"rect" : [ 1322.0, 79.0, 1660.0, 1327.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1102.0, 652.5, 34.0, 22.0 ],
					"text" : "*~ 5."
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1102.0, 687.0, 121.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 975.0, 652.5, 34.0, 22.0 ],
					"text" : "*~ 5."
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 975.0, 687.0, 121.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 845.0, 652.5, 34.0, 22.0 ],
					"text" : "*~ 5."
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 845.0, 687.0, 121.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 713.0, 652.5, 34.0, 22.0 ],
					"text" : "*~ 5."
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 713.0, 687.0, 121.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 836.0, 401.0, 200.0, 200.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1259.0, 6.0, 372.0, 214.0 ],
...
, 			{
		...
		"parameters" : 		{
			"obj-2::obj-20" : [ "live.button[1]", "live.button", 0 ],
			"obj-2::obj-37" : [ "live.button[2]", "live.button[2]", 0 ],
			"obj-2::obj-75" : [ "pw[1]", "pw", 0 ],
			"obj-30::obj-16" : [ "range[3]", "range", 0 ],
			"obj-24" : [ "live.gain~[1]", "live.gain~", 0 ],
			"obj-2::obj-33::obj-33" : [ "led[5]", "led", 0 ],
			"obj-2::obj-76" : [ "pw[2]", "pw", 0 ],
			"obj-32::obj-16" : [ "range[4]", "range", 0 ],
			"obj-2::obj-61::obj-33" : [ "led[9]", "led", 0 ],
			"obj-2::obj-52" : [ "freq[1]", "freq", 0 ],
			"obj-17::obj-52" : [ "multiply", "multiply", 0 ],
			"obj-2::obj-27::obj-33" : [ "led[4]", "led", 0 ],
			"obj-4::obj-16" : [ "range[1]", "range", 0 ],
			"obj-12::obj-16" : [ "range", "range", 0 ],
			"obj-2::obj-69" : [ "pw", "pw", 0 ],
			"obj-2::obj-58::obj-33" : [ "led[1]", "led", 0 ],
			"obj-17::obj-129" : [ "Points", "Points", 0 ],
			"obj-2::obj-39::obj-33" : [ "led[11]", "led", 0 ],
			"obj-2::obj-38::obj-33" : [ "led[10]", "led", 0 ],
			"obj-15::obj-51" : [ "Rate", "Rate", 0 ],
			"obj-25::obj-16" : [ "range[2]", "range", 0 ],
			"obj-2::obj-48::obj-33" : [ "led[2]", "led", 0 ],
			...
			"obj-2::obj-42::obj-33" : [ "led[3]", "led", 0 ],
			"obj-2::obj-62::obj-33" : [ "led[12]", "led", 0 ],
			"parameterbanks" : 			{
