...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 607.0, 101.0, 62.0, 22.0 ],
					"text" : "phasor~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 783.0, 915.0, 295.0, 116.0 ],
					"varname" : "bp.Ladder",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 783.0, 781.0, 113.0, 116.0 ],
					"varname" : "bp.VCA[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1407.0, 755.0, 121.0, 116.0 ],
					"varname" : "bp.History",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 1.0, 1.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1132.0, 637.0, 234.0, 116.0 ],
					"varname" : "bp.ADSR",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 783.0, 497.0, 217.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 783.0, 637.0, 314.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1666.5, 385.5, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 1570.0, 25.0, 192.0, 214.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1911.0, 110.0, 71.0, 116.0 ],
					"varname" : "bp.Gate Pad",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 2017.0, 426.0, 53.0, 116.0 ],
					"varname" : "bp.Input",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1890.0, 593.0, 92.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 2002.0, 730.0, 122.0, 116.0 ],
					"varname" : "bp.Constant",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 2011.0, 573.0, 113.0, 116.0 ],
					"varname" : "bp.VCA",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1961.0, 910.0, 137.0, 116.0 ],
					"varname" : "bp.LFO",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 783.0, 101.0, 214.0, 116.0 ],
					"varname" : "bp.CV LFO",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 783.0, 233.0, 726.0, 232.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 975.064574999999991, 58.0, 22.0 ],
					"text" : "hoa.dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"order" : 5,
					"patching_rect" : [ 111.0, 637.0, 254.000000000000114, 254.000000000000114 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 394.0, 925.0, 259.032287999999994, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 106.967712000000006, 925.0, 259.0, 259.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 123.714285714285751, 356.0, 350.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 111.0, 233.0, 348.000000000000227, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-12::obj-12" : [ "power", "power", 0 ],
			"obj-2::obj-89" : [ "FreqRate", "Rate", 0 ],
			"obj-25::obj-20" : [ "Freq[2]", "Freq", 0 ],
