...
struct LRTDecimator {
    ...
    LRTDecimator(int oversample, int quality) {
        LRTDecimator::oversample = oversample;
        LRTDecimator::quality = quality;
...
struct Resampler {
    ...
    LRTDecimator *decimator[CHANNELS];
    ...
    Resampler(int oversample, int quality = 4) {
        ...
        for (int i = 0; i < CHANNELS; i++) {
            decimator[i] = new LRTDecimator(oversample, quality);
