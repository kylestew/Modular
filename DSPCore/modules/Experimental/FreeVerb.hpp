...
//                DC_CV_INPUT,
            ...
            DoubleRingBuffer<AudioFrame<1>, 16*BLOCK_SIZE> inputBuffer;
            DoubleRingBuffer<AudioFrame<1>, 16*BLOCK_SIZE> outputBuffer;

            SpringReverb() : Module(NUM_PARAMS, NUM_OPTIONS, NUM_INPUTS, NUM_OUTPUTS, NUM_LIGHTS, NUM_LABELS, NUM_BUFFERS) {
